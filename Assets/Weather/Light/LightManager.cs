...
public class LightManager : MonoBehaviour
{
    ...
    [SerializeField, Range(1, 1440), Header("Modifiers"), Tooltip("The game's current time of day")] private float TimeOfDay;
    ...
    private void Start()
    {
        farmct = FindObjectOfType<Farm_Move>();
    ...
    IEnumerator DayCount()
    {
        while (true)
        {
            if (TimeOfDay >= 1438f)
            {
                FindObjectOfType<Farm_Move>().DayNightCount();
            }
